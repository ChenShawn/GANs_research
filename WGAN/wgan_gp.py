...
class WGAN_GP(object):
    ...
    def __init__(self, input_shape, batch_size=64, z_dim=128, g_filter_num=64, d_filter_num=64,
                 g_fc_dim=1024, d_fc_dim=1024, learning_rate=0.0002, gp_lambda=0.25, beta1=0.5,
    ...
    def train(self, reader, loop=20000, print_iteration=100, save_iteration=500,
        ...
        for it in range(loop):
            ...
            # Question: Just like f-GAN, is it also right to optimize G when D is not optimal?
            # Guess: The optimization is equivalent to optimize the lower bound of Wasserstein-1 Distance
...
if __name__ == '__main__':
    ...
    gan = WGAN_GP(input_shape=[28, 28, 1], pre_train=True)
    show_all_variables()
    gan.train(reader, loop=40000, critic_iters=1, save_iteration=800, auto_save_img=True, auto_save_model=False)
